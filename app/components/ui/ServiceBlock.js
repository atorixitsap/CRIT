              ...
              <div className="rounded-2xl shadow-2xl overflow-hidden flex items-center justify-center bg-gray-100 p-4">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-2 xl:grid-cols-2 gap-4 w-full max-w-2xl">
                  <div className="rounded-xl flex items-center justify-center animate-pulse bg-red-100 p-1" style={{ animationDelay: '0s' }}>
                    <img src="https://res.cloudinary.com/dejoyxstf/image/upload/v1765453254/image_6_lvoizz.avif" alt="Overview 1" className="w-40 h-40 object-contain rounded" />
                  </div>
                  <div className="rounded-xl flex items-center justify-center animate-pulse bg-red-100 p-1" style={{ animationDelay: '0.2s' }}>
                    <img src="https://res.cloudinary.com/dejoyxstf/image/upload/v1765453254/image_5_fnbiej.avif" alt="Overview 2" className="w-40 h-40 object-contain rounded" />
                  </div>
                  <div className="rounded-xl flex items-center justify-center animate-pulse bg-red-100 p-1" style={{ animationDelay: '0.4s' }}>
                    <img src="https://res.cloudinary.com/dejoyxstf/image/upload/v1765453255/image_4_axc8xb.avif " alt="Overview 3" className="w-40 h-40 object-contain rounded" />
                  </div>
                  <div className="rounded-xl flex items-center justify-center animate-pulse bg-red-100 p-1" style={{ animationDelay: '0.6s' }}>
                    <img src="https://res.cloudinary.com/dejoyxstf/image/upload/v1765453297/image_1_cgy00w.jpg" alt="Overview 4" className="w-40 h-40 object-contain rounded" />
                  </div>
                  <div className="rounded-xl flex items-center justify-center animate-pulse bg-red-100 p-1" style={{ animationDelay: '0.8s' }}>
                    <img src="https://res.cloudinary.com/dejoyxstf/image/upload/v1765453255/image_3_lwv6dm.avif" alt="Overview 5" className="w-40 h-40 object-contain rounded" />
                  </div>
                  <div className="rounded-xl flex items-center justify-center animate-pulse bg-red-100 p-1" style={{ animationDelay: '1s' }}>
                    <img src="https://res.cloudinary.com/dejoyxstf/image/upload/v1765453254/image_2_aqmb63.avif" alt="Overview 6" className="w-40 h-40 object-contain rounded" />
                  </div>
                </div>
              </div>
            </div>
